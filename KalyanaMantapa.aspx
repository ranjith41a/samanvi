<%@ page language="C#" autoeventwireup="true" inherits="KalyanaMantapa, App_Web_wagb2jvd" %>
    ...
    <div class="container">
      <div class="row">
        <div class="slider-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Sri Manjunatha Swamy <em>Kalyana  Mantapa</em></h2>
            </div>
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                ...
                <div class="item">
                  <div class="thumb">
                    <img src="assets/images/k5.jpg" alt="">
                ...
                <div class="item">
                  <div class="thumb">
                    <img src="assets/images/k7.jpg" alt="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading text-center">
            <h2>About Sri Manjunatha Swamy Kalyana Mantapa</h2>
            </div>
           <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt uttersi labore et dolore magna aliqua is ipsum suspendisse ultrices gravida</p>
